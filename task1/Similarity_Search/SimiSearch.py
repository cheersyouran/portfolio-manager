...
import numpy as np
import base
import task1.Similarity_Search.utils as ut
from bitarray import bitarray
import task1.Similarity_Search.CONFIG as CONF
import time
...
def run_simi_search():
    ...
    for ind in industry.FirstIndustryName.unique():
        ...
        for secu in mapping_reverse[ind]:
            signs_mat = ut.signs_window(quote_sub, secu, CONF.WINDOW_SIZE)
    ...
    for i in range(NUM_DAY):
        ...
        top_codes = ut.generate_weights(secu_probs, date, top=CONF.TOP)
