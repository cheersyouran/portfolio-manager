...
class dqn():
    ...
    def fit(self):
        self.model.fit(self.env, nb_steps=2000, visualize=False, verbose=1, nb_max_episode_steps=10)

    def save_weights(self):
        self.model.save_weights('dqn_{}_weights.h5f'.format('porfolio'), overwrite=True)

    def test(self):
        self.model.test(self.env, nb_episodes=1, visualize=False, nb_max_episode_steps=10)